...
const arquivosPorEstado = {
  ...
  BA: [
    'eleitorado_local_votacao_2024_BA_part1.json',
    'eleitorado_local_votacao_2024_BA_part2.json',
    'eleitorado_local_votacao_2024_BA_part3.json',
  ],
  CE: [
    'eleitorado_local_votacao_2024_CE_part1.json',
    'eleitorado_local_votacao_2024_CE_part2.json',
  ],
  ES: ['eleitorado_local_votacao_2024_ES_part1.json'],
  GO: ['eleitorado_local_votacao_2024_GO_part1.json'],
  MA: [
    'eleitorado_local_votacao_2024_MA_part1.json',
    'eleitorado_local_votacao_2024_MA_part2.json',
  ],
  MG: [
    'eleitorado_local_votacao_2024_MG_part1.json',
    'eleitorado_local_votacao_2024_MG_part2.json',
    'eleitorado_local_votacao_2024_MG_part3.json',
  ],
  MS: ['eleitorado_local_votacao_2024_MS_part1.json'],
  MT: ['eleitorado_local_votacao_2024_MT_part1.json'],
  PA: [
    'eleitorado_local_votacao_2024_PA_part1.json',
    'eleitorado_local_votacao_2024_PA_part2.json',
  ],
  PB: ['eleitorado_local_votacao_2024_PB_part1.json'],
  PE: [
    'eleitorado_local_votacao_2024_PE_part1.json',
    'eleitorado_local_votacao_2024_PE_part2.json',
  ],
  PI: ['eleitorado_local_votacao_2024_PI_part1.json'],
  PR: [
    'eleitorado_local_votacao_2024_PR_part1.json',
    'eleitorado_local_votacao_2024_PR_part2.json',
  ],
  RJ: [
    'eleitorado_local_votacao_2024_RJ_part1.json',
    'eleitorado_local_votacao_2024_RJ_part2.json',
    'eleitorado_local_votacao_2024_RJ_part3.json',
  ],
  ...
  RS: [
    'eleitorado_local_votacao_2024_RS_part1.json',
    'eleitorado_local_votacao_2024_RS_part2.json',
  ],
  ...
  SP: [
    ...
    'eleitorado_local_votacao_2024_SP_part5.json',
    'eleitorado_local_votacao_2024_SP_part6.json',
  ],
